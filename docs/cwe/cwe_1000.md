...
1. [CWE-798](https://cwe.mitre.org/data/definitions/798.html) has 3 Parents per Relationships for View-1000:
...
2. It links to 3 Pillars (Navy) as shown by the orange Paths to Pillars
   1.  CWE-284 is the Primary Pillar based on the Primary Path (heavy orange path in diagram)
