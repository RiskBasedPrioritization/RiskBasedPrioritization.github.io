...
!!! abstract "Overview"
    ...
    Any solution should be informed by what the user wants, and the rationale behind the solution implementation. This allows understanding and validation of the solution against TODO. 

    In this section

    - we start by looking at users' requirements as expressed as [User Scenarios and User Stories](../requirements/Requirements.md)
    - we take an example Remediation Policy for an organization, and see what the impact is of picking an EPSS threshold
  
    !!! warning "The guidance here is highly opinionated - not official EPSS guidance as FIRST EPSS can't be prescriptive for your context"
...
* See section [CVSS Exploit Maturity](../cvss/CVSS.md#cvss-exploit-maturity) for more details, including 
    ...
    * an example project that does this and includes EPSS scores and thresholds
...
These points will be covered in detail below. 
...
1.  Remediate vulnerabilities that have weaponized exploits or evidence
    ...
    Exploitation and above in our [Likelihood of Exploitation diagram](../risk/Understanding_Risk.md#where-cvss-epss-cisa-kev-fit) 
